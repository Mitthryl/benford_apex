...
//   */
//  protected Map<String, PartyData> wordMapFile = new HashMap<>();
//
//  /**
//   * {@literal (word => frequency)} map: global, all words
//   */
//  protected Map<String, PartyData> wordMapGlobal = new HashMap<>();
//
//  /**
...
//   */
//  protected transient List<PartyData> fileFinalList;
//
//  /**
...
//   */
//  public final transient DefaultInputPort<List<PartyData>> input = new DefaultInputPort<List<PartyData>>()
//  {
//    @Override
//    public void process(List<PartyData> list)
//    {
//      // blend incoming list into wordMapFile and wordMapGlobal
//      for (PartyData pData : list) {
//        final String party = pData.party;
//        PartyData filePair = wordMapFile.get(party);
//        if (null != filePair) {    // word seen previously in current file
//          PartyData globalPair = wordMapGlobal.get(party);    // cannot be null
//          for(int i = 0; i < 10; i++) {
//            filePair.count[i] += pData.count[i];
//            globalPair.count[i] += pData.count[i];
//          }
//          continue;
//        }
//
//        // new word in current file
//        filePair = new PartyData(party);
//        for(int i = 0; i < 10; i++) {
//          filePair.count[i] = pData.count[i];
//        }
//        wordMapFile.put(party, filePair);
//
//        // check global map
//        PartyData globalPair = wordMapGlobal.get(party);    // may be null
...
//        globalPair = new PartyData(party);
//        for(int i = 0; i < 10; i++) {
//          globalPair.count[i] = pData.count[i];
//        }
//        wordMapGlobal.put(party, globalPair);
//      }
//    }
//  };
//
